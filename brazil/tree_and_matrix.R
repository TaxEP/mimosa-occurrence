...
mimosa_br <- read.csv("datasets/mimosa-clean_hc.csv", na.strings = c("", NA))
...
# Saving as *.nex
write.nexus(mimosa_pruned.tree, file = "trees/mimosa-pruned_tree_hc.nex")
...
write.csv(mimosa_matrix, "datasets/mimosa_matrix-hc.csv", row.names = TRUE)
